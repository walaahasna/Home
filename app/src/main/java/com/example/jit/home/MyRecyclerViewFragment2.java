 ...
 */
public class MyRecyclerViewFragment2 extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        MyApplication.getInstance().addToReqQueue(jreq);        /////////////////////////////
         ...
         Program s1 = new Program("Amazing Stories","09 - 10","Science Program", R.drawable.as,4);
        Program s4 = new Program("World Discovery","13 - 14","Geographic Program", R.drawable.wd,4);
        Program s2 = new Program("Iron Man","12 - 13","Action Movie",R.drawable.im,4);
        Program s5 = new Program("The cure","10 - 11","Health Program",R.drawable.tc,4);

        Program s3 = new Program("News","11 - 12","World News",R.drawable.worldnews,4);
        //  Programs = new ArrayList<Program>();
         Programs.add(s1);
        Programs.add(s5);
        Programs.add(s3);
        ...
        Programs.add(s2);
        Programs.add(s4);
        MainActivity.All_PROG.add(s1);        MainActivity.All_PROG.add(s5);
        MainActivity.All_PROG.add(s3);
        MainActivity.All_PROG.add(s2);
        MainActivity.All_PROG.add(s4);
